...
public class SearchActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        RecommendedTopicsAdapter recommendedTopicsAdapter = new RecommendedTopicsAdapter(getApplicationContext());
        ...
        RecommendedSpeakersAdapter recommendedSpeakersAdapter = new RecommendedSpeakersAdapter(getApplicationContext());
        ...
        RecommendedSubtitleLanguagesAdapter recommendedSubtitleLanguagesAdapter = new RecommendedSubtitleLanguagesAdapter(getApplicationContext());
        ...
        RecommendedEventsAdapter recommendedEventsAdapter = new RecommendedEventsAdapter(getApplicationContext());
